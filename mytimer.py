...
class Timer():
    ...
    # -1 is used as "magic number", this method should only be called with positive number
    # if it isn't given a number then -1 indicates no new time given
    ...
    def get_time_remaining(self):
        ...
        if (current_time <= 0):
            return 0
        return math.ceil(current_time)      # rounds the time up to nearest whole second 
