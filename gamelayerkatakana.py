...
import mainmenu
from dataCardsAvailable_katakana_jpn import cards_available_katakana_jpn
from dataCardsAvailable_katakana_eng import cards_available_katakana_eng
...
IMAGE_ASSET_DIR = 'assets/images/katakana/'


class GameLayerKatakana(cocos.layer.Layer):
    is_event_handler = True

    def __init__(self, hud, scenario, difficulty):
        super(GameLayerKatakana, self).__init__()
        ...
        self.all_cards = CardTable(self, CARD_START_X, CARD_START_Y, CARD_BACK, 
                            cards_available_katakana_jpn, cards_available_katakana_eng, self.scenario, IMAGE_ASSET_DIR)
        # Set up the table
...
def new_game_katakana(difficulty):
    scenario = get_scenario()
    background = scenario.get_background()
    hud = HUD()
    game_layer = GameLayerKatakana(hud, scenario, difficulty)
